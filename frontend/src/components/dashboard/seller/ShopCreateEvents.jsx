...
const ShopCreateEvents = () => {
  ...
  const handleStartDateChange = function (e) {
    const startingDate = new Date(e.target.value);
    const minEndingDate = new Date(
      startingDate.getTime() + 3 * 24 * 60 * 60 * 1000
    );
    setStartDate(startingDate);
    setEndDate(minEndingDate);
  };

  const handleEndDateChange = function (e) {
    const endingDate = new Date(e.target.value);
